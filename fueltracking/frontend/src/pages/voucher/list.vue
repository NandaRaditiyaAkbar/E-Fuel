                ...
                <div class="container-fluid">
                    <div class="row justify-between q-col-gutter-md">
                        ...
                        <div class="col-md-auto col-12 " >
                            <template v-if="auth.canView('/voucher/add')">
                                <q-btn       :rounded="false"  size=""  color="primary" no-caps  unelevated   @click="app.openPageDialog({ page: 'voucher/add', url: `/voucher/add` , closeBtn: true  })"  class="full-width" >
                            ...
                            <div >
                                <template v-if="showBreadcrumbs && $route.query.tag">
                                    <q-breadcrumbs class="q-pa-md">
                                        <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/voucher"></q-breadcrumbs-el>
                                        ...
                                        <div class="col">
                                            <q-card class=" nice-shadow-6">
                                                ...
                                                <div >
                                                    ...
                                                    :bordered="false"
                                                    :columns="app.menus.VoucherTableHeaderItems" 
                                                    :rows="records"
                                                    binary-state-sort
                                                                    ...
                                                                    <q-list >
                                                                        <q-item>
                                                                            <q-item-section  class="">
                                                                                ...
                                                                                <q-item-label class="text-bold">
                                                                                    <q-chip v-if="props.row.tanggal" dense size="13px" :label="$utils.relativeDate(props.row.tanggal)">
                                                                                    <q-tooltip content-class="bg-accent" transition-show="scale" transition-hide="scale">
                                                                                    {{ $utils.humanDatetime(props.row.tanggal) }}
                                                                                    </q-tooltip>
                                                                                    </q-chip>
                                                                                </q-item-label>
                                                                            </q-item-section>
                                                                        ...
                                                                        <q-item>
                                                                            <q-item-section  class="">
                                                                                ...
                                                                                <q-item-label class="text-bold">
                                                                                    <image-viewer image-size="medium" image-preview-size="" :src="props.row.foto_dashboard" width="50px" height="50px" :num-display="1">
                                                                                    </image-viewer>
                                                                                </q-item-label>
                                                                            </q-item-section>
                                                                        </q-item>
                                                                        ...
                                                                        <q-item>
                                                                            <q-item-section  class="">
                                                                                ...
                                                                                <q-item-label class="text-bold">
                                                                                    <image-viewer image-size="medium" image-preview-size="" :src="props.row.foto_struk" width="50px" height="50px" :num-display="1">
                                                                                    </image-viewer>
                                                                                </q-item-label>
                                                                            </q-item-section>
                                                                        </q-item>
                                                                        ...
                                                                        <q-item>
                                                                            <q-item-section  class="">
                                                                                ...
                                                                                <q-item-label class="text-bold">
                                                                                    <image-viewer image-size="medium" image-preview-size="" :src="props.row.bukti_pengajuan" width="50px" height="50px" :num-display="1">
                                                                                    </image-viewer>
                                                                                </q-item-label>
                                                                            </q-item-section>
                                                                        </q-item>
                                                                            ...
                                                                            <q-btn icon="menu" padding="xs" round flat color="grey">
                                                                                <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                                                    <q-list dense rounded nav>
                                                                                        <template v-if="auth.canView('voucher/view')">
                                                                                            <q-item link clickable v-ripple :to="`/voucher/view/${props.row.id}`">
                                                                                                <q-item-section>
                                                                                        ...
                                                                                        <template v-if="auth.canView('voucher/edit')">
                                                                                            <q-item link clickable v-ripple @click="app.openPageDialog({ page:'voucher/edit', url: `/voucher/edit/${props.row.id}` , closeBtn: true })">
                                                                                                <q-item-section>
                                                                                        ...
                                                                                        <template v-if="auth.canView('voucher/delete')">
                                                    ...
                                                    <div class="q-pa-sm" v-show="pageReady">
                                                        <div class="row justify-between">
                                                            <div class="row q-col-gutter-md">
                                                                ...
                                                                <div>
                                                                    <q-btn v-if="exportButton"    :rounded="false"  no-caps  unelevated   color="accent" class="q-my-xs" @click="exportPage()" label=""  title="Export" icon="print">
                                                                    </q-btn>
                                                                </div>
                                                            </div>
