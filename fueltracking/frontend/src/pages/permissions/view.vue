                                        ...
                                        <div class="row q-col-gutter-x-md">
                                            <div class="col">
                                                <q-card class=" nice-shadow-6">
                                                    ...
                                                    <q-item>
                                                        <q-item-section class="col-auto col-md-3">
                                                            <q-item-label class="text-bold">Guard Name </q-item-label>
                                                        </q-item-section>
                                                        <q-item-section>
                                                            <q-item-label caption>{{ item.guard_name }}</q-item-label>
                                                        </q-item-section>
                                                    </q-item>
                                                    <q-separator></q-separator>
                                                    <q-item>
                                                    ...
                                                    <q-item>
                                                        <q-item-section class="col-auto col-md-3">
                                                            <q-item-label class="text-bold">Updated At </q-item-label>
                                                        </q-item-section>
                                                        <q-item-section>
                                                            ...
                                                            <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                                <q-list dense rounded nav>
                                                                    <template v-if="auth.canView('permissions/edit')">
                                                                        <q-item link clickable v-ripple @click="app.openPageDialog({ page:'permissions/edit', url: `/permissions/edit/${item.id}` , closeBtn: true })">
                                                                            <q-item-section>
