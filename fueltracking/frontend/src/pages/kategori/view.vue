                                            ...
                                            <div class="col">
                                                <q-card class=" nice-shadow-6">
                                                    ...
                                                    <q-item>
                                                        ...
                                                        <q-item-section>
                                                            <q-item-label caption>{{ item.kategori }}</q-item-label>
                                                        </q-item-section>
                                                    </q-item>
                                                    <q-separator></q-separator>
                                                    <q-item>
                                                        <q-item-section class="col-auto col-md-3">
                                                            <q-item-label class="text-bold">Jenis Kendaraan </q-item-label>
                                                        </q-item-section>
                                                        <q-item-section>
                                                            <q-item-label caption>{{ item.jenis_kendaraan }}</q-item-label>
                                                        </q-item-section>
                                                    </q-item>
                                                    <q-separator></q-separator>
                                                    <q-item>
                                                        <q-item-section class="col-auto col-md-3">
                                                            <q-item-label class="text-bold">Jenis Bbm </q-item-label>
                                                        </q-item-section>
                                                        <q-item-section>
                                                            <q-item-label caption>{{ item.jenis_bbm }}</q-item-label>
                                                        </q-item-section>
                                                    </q-item>
                                                    <q-separator></q-separator>
                                                    <q-item>
                                                        <q-item-section class="col-auto col-md-3">
                                                            <q-item-label class="text-bold">No Polisi </q-item-label>
                                                        </q-item-section>
                                                        <q-item-section>
                                                            <q-item-label caption>{{ item.no_polisi }}</q-item-label>
                                                        </q-item-section>
                                                    </q-item>
                                                    <q-separator></q-separator>
                                                            ...
                                                            <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                                <q-list dense rounded nav>
                                                                    <template v-if="auth.canView('kategori/edit')">
                                                                        <q-item link clickable v-ripple @click="app.openPageDialog({ page:'kategori/edit', url: `/kategori/edit/${item.id}` , closeBtn: true })">
                                                                            <q-item-section>
