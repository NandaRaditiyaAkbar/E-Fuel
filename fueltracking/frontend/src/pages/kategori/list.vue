                ...
                <div class="container-fluid">
                    <div class="row justify-between q-col-gutter-md">
                        ...
                        <div class="col-md-auto col-12 " >
                            <template v-if="auth.canView('/kategori/add')">
                                <q-btn       :rounded="false"  size=""  color="primary" no-caps  unelevated   @click="app.openPageDialog({ page: 'kategori/add', url: `/kategori/add` , closeBtn: true  })"  class="full-width" >
                            ...
                            <div >
                                <template v-if="showBreadcrumbs && $route.query.tag">
                                    <q-breadcrumbs class="q-pa-md">
                                        <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/kategori"></q-breadcrumbs-el>
                                        ...
                                        <div class="col">
                                            <q-card class=" nice-shadow-6">
                                                ...
                                                <div >
                                                    ...
                                                    :bordered="false"
                                                    :columns="app.menus.KategoriTableHeaderItems" 
                                                    :rows="records"
                                                    binary-state-sort
                                                    ...
                                                    <template v-slot:body="props">
                                                        <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                                            ...
                                                            <q-td  key="id" :props="props">
                                                                <q-btn padding="xs"   :rounded="false"  color="primary"  no-caps  unelevated   flat :to="`/kategori/view/${props.row.id}`">{{ props.row.id }}</q-btn>
                                                            </q-td>
                                                            <q-td  key="kategori" :props="props">
                                                                {{ props.row.kategori }}
                                                            </q-td>
                                                            <q-td  key="jenis_kendaraan" :props="props">
                                                                {{ props.row.jenis_kendaraan }}
                                                            </q-td>
                                                            <q-td  key="jenis_bbm" :props="props">
                                                                {{ props.row.jenis_bbm }}
                                                            </q-td>
                                                            <q-td  key="no_polisi" :props="props">
                                                                {{ props.row.no_polisi }}
                                                            </q-td>
                                                                    ...
                                                                    <q-btn icon="menu" padding="xs" round flat color="grey">
                                                                        <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                                            <q-list dense rounded nav>
                                                                                <template v-if="auth.canView('kategori/view')">
                                                                                    <q-item link clickable v-ripple :to="`/kategori/view/${props.row.id}`">
                                                                                        <q-item-section>
                                                                                ...
                                                                                <template v-if="auth.canView('kategori/edit')">
                                                                                    <q-item link clickable v-ripple @click="app.openPageDialog({ page:'kategori/edit', url: `/kategori/edit/${props.row.id}` , closeBtn: true })">
                                                                                        <q-item-section>
                                                                                ...
                                                                                <template v-if="auth.canView('kategori/delete')">
