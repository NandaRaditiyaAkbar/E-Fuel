                    ...
                    <div class="row justify-between q-col-gutter-md">
                        ...
                        <div class="col-md-auto col-12 " >
                            <template v-if="auth.canView('/users/add')">
                                <q-btn       :rounded="false"  size=""  color="primary" no-caps  unelevated   @click="app.openPageDialog({ page: 'users/add', url: `/users/add` , closeBtn: true  })"  class="full-width" >
                                        ...
                                        <div class="col">
                                            <q-card class=" nice-shadow-6">
                                                ...
                                                <div >
                                                    ...
                                                    :bordered="false"
                                                    :columns="app.menus.UsersTableHeaderItems" 
                                                    :rows="records"
                                                    binary-state-sort
                                                                        ...
                                                                        <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                                            <q-list dense rounded nav>
                                                                                ...
                                                                                <template v-if="auth.canView('users/edit')">
                                                                                    <q-item link clickable v-ripple @click="app.openPageDialog({ page:'users/edit', url: `/users/edit/${props.row.id}` , closeBtn: true })">
                                                                                        <q-item-section>
