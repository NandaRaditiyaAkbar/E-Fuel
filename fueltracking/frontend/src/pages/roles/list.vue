                    ...
                    <div class="row justify-between q-col-gutter-md">
                        ...
                        <div class="col-md-auto col-12 " >
                            <template v-if="auth.canView('/roles/add')">
                                <q-btn       :rounded="false"  size=""  color="primary" no-caps  unelevated   @click="app.openPageDialog({ page: 'roles/add', url: `/roles/add` , closeBtn: true  })"  class="full-width" >
                                        ...
                                        <div class="col">
                                            <q-card class=" nice-shadow-6">
                                                ...
                                                <div >
                                                    ...
                                                    :bordered="false"
                                                    :columns="app.menus.RolesTableHeaderItems" 
                                                    :rows="records"
                                                    binary-state-sort
                                                                        ...
                                                                        <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                                            <q-list dense rounded nav>
                                                                                ...
                                                                                <template v-if="auth.canView('roles/edit')">
                                                                                    <q-item link clickable v-ripple @click="app.openPageDialog({ page:'roles/edit', url: `/roles/edit/${props.row.id}` , closeBtn: true })">
                                                                                        <q-item-section>
