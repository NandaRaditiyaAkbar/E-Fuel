                                        ...
                                        <div class="row q-col-gutter-x-md">
                                            <div class="col">
                                                <q-card class=" nice-shadow-6">
                                                    ...
                                                    <q-item>
                                                        <q-item-section class="col-auto col-md-3">
                                                            <q-item-label class="text-bold">Harga </q-item-label>
                                                        </q-item-section>
                                                        <q-item-section>
                                                            <q-item-label caption>{{ item.harga }}</q-item-label>
                                                        </q-item-section>
                                                    </q-item>
                                                    <q-separator></q-separator>
                                                            ...
                                                            <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                                <q-list dense rounded nav>
                                                                    <template v-if="auth.canView('tb_bahanbakar/edit')">
                                                                        <q-item link clickable v-ripple @click="app.openPageDialog({ page:'tb_bahanbakar/edit', url: `/tb_bahanbakar/edit/${item.id}` , closeBtn: true })">
                                                                            <q-item-section>
...
<script setup>
	...
	const props = defineProps({
		...
		routeName: {
			type: String,
			default: 'tb_bahanbakarview',
		},
		apiPath: {
			type: String,
			default: 'tb_bahanbakar/view',
		},
		editButton: {
			type: Boolean,
			default: true,
