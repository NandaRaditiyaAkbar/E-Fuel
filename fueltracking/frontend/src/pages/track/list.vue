                            ...
                            <div >
                                <template v-if="showBreadcrumbs && $route.query.tag">
                                    <q-breadcrumbs class="q-pa-md">
                                        <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/track"></q-breadcrumbs-el>
                                        ...
                                        <div class="col">
                                            <q-card class=" nice-shadow-6">
                                                ...
                                                <div >
                                                    ...
                                                    :bordered="false"
                                                    :columns="app.menus.TrackTableHeaderItems" 
                                                    :rows="records"
                                                    binary-state-sort
                                                    ...
                                                    <template v-slot:body="props">
                                                        <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                                            ...
                                                            <q-td  key="foto_dashboard" :props="props">
                                                                    ...
                                                                    <q-btn icon="menu" padding="xs" round flat color="grey">
                                                                        <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                                            <q-list dense rounded nav>
                                                                                <template v-if="auth.canView('track/view')">
                                                                                    <q-item link clickable v-ripple :to="`/track/view/${props.row.id}`">
                                                                                        <q-item-section>
                                                                                ...
                                                                                <template v-if="auth.canView('track/edit')">
                                                                                    <q-item link clickable v-ripple @click="app.openPageDialog({ page:'track/edit', url: `/track/edit/${props.row.id}` , closeBtn: true })">
                                                                                        <q-item-section>
