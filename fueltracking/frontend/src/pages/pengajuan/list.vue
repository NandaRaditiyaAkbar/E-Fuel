                ...
                <div class="container-fluid">
                    <div class="row justify-between q-col-gutter-md">
                        ...
                        <div class="col-md-auto col-12 " >
                            <template v-if="auth.canView('/pengajuan/add')">
                                <q-btn       :rounded="false"  size=""  color="primary" no-caps  unelevated   @click="app.openPageDialog({ page: 'pengajuan/add', url: `/pengajuan/add` , closeBtn: true  })"  class="full-width" >
                            ...
                            <div >
                                <template v-if="showBreadcrumbs && $route.query.tag">
                                    <q-breadcrumbs class="q-pa-md">
                                        <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/pengajuan"></q-breadcrumbs-el>
                                        ...
                                        <div class="col">
                                            <q-card class=" nice-shadow-6">
                                                <div >
                                                    ...
                                                    :columns="app.menus.PengajuanTableHeaderItems" 
                                                    :rows="records" 
                                                    row-key="id" 
                                                        ...
                                                        <div class="col-12">
                                                            <q-card :bordered="false" class="nice-shadow-6">
                                                                <q-item clickable :active="isCurrentRecord(props.row)" active-class="bg-blue-1">
                                                                    <q-item-section v-ripple @click="app.navigateTo(`/pengajuan/view/${props.row.id}`)">
                                                                        <q-item-label class="text-primary text-bold cursor-pointer" lines="2">{{ $utils.humanDatetime(props.row.tanggal) }}</q-item-label>
                                                                        <q-item-label class="text-caption" lines="2">{{ props.row.nama }}</q-item-label>
                                                                            ...
                                                                            <q-btn icon="menu" padding="xs" round flat color="grey">
                                                                                <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                                                    <q-list dense rounded nav>
                                                                                        <template v-if="auth.canView('pengajuan/view')">
                                                                                            <q-item link clickable v-ripple :to="`/pengajuan/view/${props.row.id}`">
                                                                                                <q-item-section>
                                                                                        ...
                                                                                        <template v-if="auth.canView('pengajuan/edit')">
                                                                                            <q-item link clickable v-ripple @click="app.openPageDialog({ page:'pengajuan/edit', url: `/pengajuan/edit/${props.row.id}` , closeBtn: true })">
                                                                                                <q-item-section>
...
<script setup>
	...
	const props = defineProps({
		...
		routeName : {
			type : String,
			default : 'pengajuanlist',
		},
		apiPath : {
			type : String,
			default : 'pengajuan/index',
		},
		paginate: {
			type: Boolean,
			default: true,
