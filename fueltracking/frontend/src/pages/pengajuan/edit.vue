                                                    ...
                                                    <div class="col-12">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-9 col-12">
                                                                <q-select     outlined dense  ref="ctrlstatus" emit-value map-options  v-model="formData.status" :options="app.menus.statusItems" label="Status"  :error="isFieldValid('status')" :error-message="getFieldError('status')">
                                                                </q-select> 
                                                            </div>
                                                        </div>
                                                    </div>
...
<script setup>
	...
	const props = defineProps({
		...
		routeName: {
			type: String,
			default: 'pengajuanedit',
		},
		pagePath: {
			type : String,
			default : 'pengajuan/edit',
		},
		apiPath: {
			type: String,
			default: 'pengajuan/edit',
		...
		msgAfterUpdate: {
			type: String,
			default: "Status Pengajuan Telah Diperbarui",
		},
		formValidationError: {
			type: String,
