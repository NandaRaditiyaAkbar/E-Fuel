                                    ...
                                    <div class="row q-col-gutter-x-md">
                                        <div class="col-12">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9 col-12">
                                                    <q-select     outlined dense  ref="ctrltanggal" emit-value map-options  v-model="formData.tanggal" :options="[]" label="Tanggal"  :error="isFieldValid('tanggal')" :error-message="getFieldError('tanggal')">
                                                    </q-select> 
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9 col-12">
                                                    <q-select     outlined dense  ref="ctrlnama" emit-value map-options  v-model="formData.nama" :options="[]" label="Nama"  :error="isFieldValid('nama')" :error-message="getFieldError('nama')">
                                                    </q-select> 
                                                </div>
                                            </div>
                                        </div>
...
<script setup>
	...
	const props = defineProps({
		...
		routeName : {
			type : String,
			default : 'pengajuanadd',
		},
		apiPath : {
			type : String,
			default : 'pengajuan/add',
		},
		submitButtonLabel: {
			type: String,
			default: "Submit",
	...
	function afterSubmit(response) {
		...
		if(props.redirect) app.navigateTo(`/pengajuan`);
	}
	//page state
	const {
